...
- Separate planning from execution. Use Plan mode or a reviewed plan before any write, run, or irreversible step.
...
- Design for four memory layers: **working** (current session), **episodic** (history), **semantic** (facts), and **procedural** (rules such as `AGENTS.md`, skills, and rules files).
